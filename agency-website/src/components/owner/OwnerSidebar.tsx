...
const navLinks = [
  ...
  { name: "Clients", href: "/owner/clients", icon: UserGroupIcon },
  { name: "Account", href: "/owner/account", icon: UserCircleIcon },
];
  ...
  return (
    <>
      ...
      <aside className={`hidden md:flex flex-col min-h-screen bg-black/60 border-r border-white/10 py-8 px-4 relative z-20 transition-all duration-300 ease-in-out ${
        ...
        {/* Owner Info Banner */}
        {!isCollapsed && (
          <div className="mt-6 p-4 rounded-xl bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-400/20 text-purple-200 text-base font-medium hover:bg-gradient-to-r hover:from-purple-500/20 hover:to-blue-500/20 hover:border-purple-400/40 hover:shadow-xl transition-all duration-300">
            <div className="mb-1 font-semibold text-purple-300">Owner Dashboard</div>
