...
export default function InvitePage() {
  ...
  const { setupAccount, isLoading, error, clearError } = useAuth();
  ...
  useEffect(() => {
    const loadInvitationInfo = async () => {
      if (!token) {
        notify({ message: 'No invitation token provided', type: 'error' });
        return;
      }
    ...
    return (
      <div className="min-h-screen bg-dark-blue flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-white/60">Loading invitation...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-dark-blue flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-lg text-white/60 mb-8">This invitation link is invalid or has expired.</p>
      ...
      <div className="relative z-10 w-full max-w-2xl space-y-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-white/60">
            You've been invited to join <span className="text-blue-400 font-semibold">{invitationInfo.project_title}</span>
          </p>
        </div>
        ...
        <div className="mt-8 bg-black/40 backdrop-blur-sm rounded-2xl p-10 border border-white/10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="phone" className="block text-lg font-medium text-white/80">
                Phone Number
              </label>
              <div className="mt-2">
                <input
